...
export { type DataLayerObject, GTM_ID_PATTERN, type GtmIdContainer, type GtmQueryParams, GtmSupport, type GtmSupportOptions, type LoadScriptOptions, type OnReadyOptions, type TrackEventOptions, assertIsGtmId, hasScript, loadScript };
